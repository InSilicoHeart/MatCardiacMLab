%===============================================================================
% CellML file:   ten_Tusscher_Panfilov_2006_MID.cellml
% CellML model:  tentusscher_panfilov_2006_M_cell
% Date and time: 21/01/2011 at 10:57:51
%-------------------------------------------------------------------------------
...
function [dY, CompVar] = ten_Tusscher_Panfilov_2006_MID(time, Y, Constants, Values)

%-------------------------------------------------------------------------------
% Initial conditions
%-------------------------------------------------------------------------------

% Y = [3.288e-5, 0.9526, 0.9942, 0.7026, 4.272, 0.000153, 0.00042, 0.8978, 0.749, 0.6788, 0.00165, -85.423, 138.52, 0.0165, 0.473, 0.0174, 10.132, 2.347e-8, 0.999998];
...
g_Ks = 0.098;   % nanoS_per_picoF (in slow_time_dependent_potassium_current)
